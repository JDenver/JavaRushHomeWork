...
*/
        ...
        Cat dad = new Cat(reader.readLine(), grandFather, null);
        Cat mom = new Cat(reader.readLine(), null, grandMother);
        Cat son = new Cat(reader.readLine(), dad, mom);
        Cat daughter = new Cat(reader.readLine(), dad, mom);
